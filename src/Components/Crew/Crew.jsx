...
const Crew = () => {
  ...
  return (
    <div className=" w-full h-full lg:bg-crew-desktop md:bg-crew-tablet bg-crew-mobile bg-cover">
      <Navbar />
      ...
      <div className="w-full h-full flex lg:flex-row md:flex-col flex-col-reverse md:pb-0 lg:justify-between lg:pl-36">
        <div className="flex flex-col lg:pr-12 lg:gap-32 lg:mt-16 md:mt-0 mt-8">
          <div className="h-full flex md:flex-col lg:items-start lg:mt-0 md:mt-14 items-center flex-col-reverse md:pb-0 pb-12">
        ...
        <div className="w-full h-full flex flex-col items-center justify-center lg:mt-0 md:mt-10">
          <div
            ...
            className=" flex md:w-[400px] md:h-[460px] w-[226.15px] h-[223px] bg-contain bg-no-repeat items-center lg:justify-end bg-center"
          />{' '}
